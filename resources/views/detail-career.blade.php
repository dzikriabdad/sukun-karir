        ...
        <div class="w-full bg-white rounded-2xl shadow-md border p-6 md:p-10">
          ...
          <div class="bg-slate-50 p-5 rounded-xl border border-slate-100 mt-8">
            ...
            <p class="text-sm text-slate-600 leading-relaxed">
              ...
              <a href="mailto:rekrutmen@sukunsigaret.com" class="text-blue-700 font-bold hover:underline transition">rekrutmen@sukunsigaret.com</a><br>
        ...
        <div class="flex flex-col gap-3 mt-2">
            ...
            @auth
                ...
                @elseif(!Auth::user()->cv)
                    ...
                    {{-- 3. JIKA BELUM ISI CV (BIAR NGGA BISA LANGSUNG LAMAR) --}}

                    <div class="p-3 bg-red-50 border border-red-200 rounded-xl text-[11px] text-red-600 font-bold text-center uppercase tracking-tighter">

                        <i class="bi bi-exclamation-triangle-fill mr-1"></i> Profil Belum Lengkap!

                    </div>

                    <a href="{{ route('pelamar.create_cv') }}" class="w-full text-center bg-amber-500 text-white font-bold py-4 px-6 rounded-xl shadow-lg shadow-amber-500/20 hover:bg-amber-600 hover:-translate-y-0.5 transition-all duration-300 uppercase tracking-wider text-sm">
                ...
                @elseif(isset($isRejected) && $isRejected)
                    ...
                    {{-- 4. PELAMAR PERNAH DITOLAK (RE-APPLY) --}}
                ...
                @elseif(isset($hasActiveApplication) && $hasActiveApplication)
                    ...
                    {{-- 5. PELAMAR SUDAH DAFTAR & MASIH DIPROSES --}}
